...
public class SRLTrainData {
    ...
    public static String getCoNLLXString(Collection<TypedDependency> deps, List<CoreLabel> tokens) {
        ...
        for (CoreLabel token : tokens) {
            ...
            String cPos = (token.get(CoreAnnotations.CoarseTagAnnotation.class) != null) ?
                    token.get(CoreAnnotations.CoarseTagAnnotation.class) : "_";
    ...
    public static void main(String[] args) {
        ...
        convertTreebankToCoNLLX("/Users/qingqingcai/Documents/IntellijWorkspace/NLPWrapper/data/data.parse",filter,true,
                "/Users/qingqingcai/Documents/IntellijWorkspace/NLPWrapper/data/conllx.txt");
    }
}
